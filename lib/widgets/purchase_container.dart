...
class PurchaseContaine extends StatefulWidget {
  const PurchaseContaine(
      {Key? key,
  ...
  @override
  State<PurchaseContaine> createState() => _PurchaseContaineState();
}

class _PurchaseContaineState extends State<PurchaseContaine> {
